...
namespace WcfService
{
    ...
    public interface IAcceuilService
    {
        ...
        [OperationContract]
        [FaultContract(typeof(Errors))]
        int RechercherNombreClientRegrouper(CsRegCli leRegroupement);

        [OperationContract]
        [FaultContract(typeof(Errors))]
        Dictionary<List<CsClientRechercher>, List<CsLclient>> RechercherClientRegrouper(CsRegCli leRegroupement, int Indice, int Nombre, ref bool Sortie);

        [OperationContract]
        [FaultContract(typeof(Errors))]
        List<CsLclient> RechercherFactureRegrouper(CsClientRechercher leClientRechercher);
        ...
        [OperationContract]
        [FaultContract(typeof(Errors))]
        List<CsDetailAffectationScelle> RetourneBorneDetailLotScelle(int IdDemande);
