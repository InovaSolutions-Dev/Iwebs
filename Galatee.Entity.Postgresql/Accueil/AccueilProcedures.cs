       ...
       public static DataTable RetourneScellageCompteur(string numero,string marque)
                                        ...
                                        galadbEntities pContext)
        {
            try
            {
                ...
                {
                    foreach (DCANALISATION item in _LstCompteur)
                        item.FK_IDABON = Abonnement.PK_ID;
                ...
                {
                    foreach (DEVENEMENT item in _LstEvenement)
                        item.FK_IDCANALISATION = _LstCompteur.FirstOrDefault(t => t.FK_IDCOMPTEUR == item.FK_IDCOMPTEUR && t.POINT == item.POINT).PK_ID;
