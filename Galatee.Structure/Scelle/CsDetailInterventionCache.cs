...
{
    public class CsDetailInterventionCache
    {
        public System.Guid ID_DetailInterventionDePoseDeScellesSurBranchementBTA_CacheBorneBTA { get; set; }
        public System.Guid ID_InterventionDePoseDeScellesSurBranchementBTA { get; set; }
        public System.Guid Cache_borne_ID { get; set; }
